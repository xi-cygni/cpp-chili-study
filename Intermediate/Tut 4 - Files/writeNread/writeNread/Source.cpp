...
int main()
{
	const int myInt = 2137;
	std::ofstream out("boi.dat", std::ios::binary);
	out.write(reinterpret_cast<const char*>(&myInt), sizeof(int)); //write takes a pointer to char = pointer to bunch of bytes
	out.close();
	...
	char buffer[256];
	aguszka::int2str(data, buffer, 256);
